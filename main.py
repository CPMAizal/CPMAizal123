...
__CHANNEL_USERNAME__ = "CPMBeka"
__GROUP_USERNAME__   = "CPMBekaChat"
...
def banner(console):
    ...
    brand_name = figlet_format('CPMBeka2', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ CPMBeka[/bold green]: Car Parking Multiplayer 2 Hacking Tool.")

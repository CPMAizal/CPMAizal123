...
def banner(console):
    ...
    brand_name = figlet_format('AizalCPM', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ Car Parking Multiplayer 2 Tool Owner of This Tool is CPMAizal [/bold green]: Get In Touch With Me To Buy An Unlimitied Balance.")

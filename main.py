...
__CHANNEL_USERNAME__ = "https://t.me/Beka3sec
...
def banner(console):
    ...
    brand_name = figlet_format('BekaCPM', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ Car Parking Multiplayer 2 Tool Owner of This Tool is CPMBeka [/bold green]: Get In Touch With Me To Buy An Unlimitied Balance.")

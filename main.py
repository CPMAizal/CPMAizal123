...
__CHANNEL_USERNAME__ = "CPMNight"
__GROUP_USERNAME__   = "CPMNightShop"
...
def banner(console):
    ...
    brand_name = figlet_format('NightCPM', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ Car Parking Multiplayer 2 Tool Owner of This Tool is CPMNight [/bold green]: Get In Touch With Me To Buy An Unlimitied Balance.")
